...
begin
  inherited;
    ...
    lblCaixaCab.Caption := 'Período de: ' +EdtDtIni.Text + ' Até: ' + EdtDtFim.Text;
    relPrevia.Preview;
end;
  ...
  With qryRel do
    Begin
      ...
      if RecordCount = 0 then
        Begin
          application.MessageBox('O Relatório está vazio e não sera gerado.','Informação',mb_ok+MB_ICONINFORMATION);
          Exit;
        End;
    End;
