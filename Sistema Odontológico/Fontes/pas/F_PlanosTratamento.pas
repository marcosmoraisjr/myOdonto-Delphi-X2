...
begin
  ...
  if not Operador.PlanoTratamentoC then
    Begin
      application.MessageBox('Operador não tem permissão para cadastrar um plano de tratamento!', 'Acesso Negado',
  ...
  if EdtCodP.Text = '' then
    Begin
      application.MessageBox('Selecione um  paciente para cadastrar um plano de tratamento!', 'Atenção!',
