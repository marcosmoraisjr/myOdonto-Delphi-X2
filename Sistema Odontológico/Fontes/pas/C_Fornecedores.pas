...
begin
  ...
  if EdtNome.Text = '' then
    Begin
      application.MessageBox('O Campo "Nome" é obrigatório o preenchimento!','Erro!!!',mb_ok+MB_ICONERROR);
      Exit;
    End;

  if (EdtRazaoSocial.Text = '') and (cbPessoa.ItemIndex = 1) then
    Begin
      application.MessageBox('O Campo "Razão Social" é obrigatório o preenchimento!','Erro!!!',mb_ok+MB_ICONERROR);
      Exit;
    End;
