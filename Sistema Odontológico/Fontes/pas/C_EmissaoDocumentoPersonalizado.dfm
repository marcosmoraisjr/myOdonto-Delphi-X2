inherited frmCadDocumentoPersonalizado: TfrmCadDocumentoPersonalizado
  ClientHeight = 262
  ClientWidth = 511
  OnCreate = FormCreate
  ExplicitWidth = 517
  ...
  inherited Panel1: TPanel
    Width = 511
    Caption = 'Emiss'#227'o de Documentos Personalizados'
    ExplicitWidth = 511
  end
  ...
  object gbConsultorio: TGroupBox [6]
    Left = 0
    Top = 156
    Width = 511
    Height = 41
  ...
  object GroupBox2: TGroupBox [7]
    ...
    object EdtCodDoc: TJvComboEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnButtonClick = EdtCodDocButtonClick
  ...
  object ConexaoWord: TADOConnection
    ConnectionString = 
      ...
      'User ID=sa;Initial Catalog=ODSWORD;Data Source=ALESSANDRO-NOTE\O' +
      'DONTOSIS'
