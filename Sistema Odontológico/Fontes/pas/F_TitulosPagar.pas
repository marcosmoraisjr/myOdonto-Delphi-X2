...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para Editar um Títulos a Pagar!',
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para Cadastrar um Títulos a Pagar!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para Deletar um Títulos a Pagar!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
  ...
  Begin
    Application.MessageBox
      ('Só é possível deletar uma conta que ainda não foi baixada', 'Atenção!',
      mb_ok + MB_ICONWARNING);
    Exit;
  End;

  If Application.MessageBox(PChar('Deseja realmente deletar a conta: ' +
    qryContasID_CONTAPAGAR.AsString + '?'), 'Atenção!',
...
begin
  ...
  Begin
    Application.MessageBox
      ('Só é possível estornar um título que já foi baixado', 'Atenção!',
      mb_ok + MB_ICONWARNING);
    Exit;
  End;
  ...
  Begin
    Application.MessageBox
      ('Operador não tem permissão para estornar um Títulos a Pagar!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
  ...
  Begin
    ...
    If Application.MessageBox
      ('Será apenas estornado o último pagamento, Deseja Continuar ?',
      'Atenção!', MB_YESNO + MB_ICONWARNING + MB_DEFBUTTON2) = IDYES Then
    Begin
      If Application.MessageBox
        ('O saldo vai para o Caixa Geral, Deseja Continuar ?', 'Atenção!',
        MB_YESNO + MB_ICONWARNING + MB_DEFBUTTON2) = IDYES Then
      Begin
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para Parcelar um Títulos a Pagar!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
  ...
  Begin
    Application.MessageBox
      ('Só é possível efetuar o parcelamento em contas que ainda não foi efetuado o pagamento',
