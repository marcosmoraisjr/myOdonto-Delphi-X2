inherited frmSelecionaServidor: TfrmSelecionaServidor
  ClientHeight = 183
  ClientWidth = 435
  OnClose = FormClose
  OnCreate = FormCreate
  ...
  object gbInformacoes: TGroupBox [7]
    Left = 0
    Top = 32
    Width = 435
    Height = 41
    ...
    object Label1: TLabel
      ...
      Width = 225
      Height = 15
      Caption = 'Selecione o Servidor e a Base de Dados.'
  ...
  object cbMostrar: TCheckBox [8]
    Left = 4
    Top = 136
    Width = 172
    Height = 17
    Alignment = taLeftJustify
    Caption = 'Sempre mostrar essa tela'
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlue
    Font.Height = -12
    Font.Name = 'Arial'
  ...
  object JvGradientHeaderPanel1: TJvGradientHeaderPanel [9]
    Left = 0
    Top = 0
    Width = 435
    Height = 32
    Hint = 'Clique Aqui para digitar a Senha do Banco de Dados.'
    GradientStartColor = 16744448
    GradientStyle = grEllipse
    LabelCaption = 'Selecione o Servidor'
    ...
    Align = alTop
    TabOrder = 6
    OnClick = UsuarioSenha1Click
  end
  object mmoScript: TMemo [10]
    Left = 0
    Top = -2
    Width = 1
    Height = 11
  ...
  object PopupMenu: TPopupMenu
    Left = 352
    Top = 47
    object UsuarioSenha1: TMenuItem
