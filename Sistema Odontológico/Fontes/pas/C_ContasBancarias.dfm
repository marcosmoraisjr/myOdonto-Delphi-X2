inherited frmCadContasBancarias: TfrmCadContasBancarias
  ClientHeight = 398
  ClientWidth = 449
  OnCreate = FormCreate
  ExplicitWidth = 455
  ...
  object GroupBox1: TGroupBox [4]
    ...
    Height = 125
    Align = alTop
    Caption = 'Dados para Emiss'#227'o de Boletos'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Tahoma'
    ...
    object EdtCNPJ: TMaskEdit
      ...
      Width = 134
      Height = 21
      EditMask = '999.999.999/999-99;1;_'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object GroupBox2: TGroupBox [5]
    ...
    object EdtCodB: TJvComboEdit
      ...
      ParentFont = False
      TabOrder = 3
      OnButtonClick = EdtCodBButtonClick
      OnExit = EdtCodBExit
      OnKeyPress = EdtCodBKeyPress
    end
