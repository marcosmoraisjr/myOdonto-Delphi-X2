...
begin
  ...
  if EdtNroConcelho.Text = '' then
    Begin
      application.MessageBox('O Campo "CRO" é obrigatório o preenchimento!','Erro!!!',mb_ok+MB_ICONERROR);
      Exit;
    End;

  if EdtUFCon.Text = '' then
    Begin
      application.MessageBox('O Campo "UF Conselho" é obrigatório o preenchimento!','Erro!!!',mb_ok+MB_ICONERROR);
      Exit;
    End;

  if (EdtNome.Text = '') and (EdtDtNasc.Text = '  /  /    ') and (EdtSexo.Text = '') and (EdtCodCidade.Text = '') then
    Begin
      application.MessageBox('Os campos em azul são obrigatórios!','Erro!!!',mb_ok+MB_ICONERROR);
      Exit;
    End;
