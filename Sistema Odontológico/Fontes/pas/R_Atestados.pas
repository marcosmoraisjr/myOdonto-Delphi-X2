    ...
    Begin
      ...
      If CFGGeral.ImpCabAtestado then
        Begin
          ...
          mmoDescricao.Lines.Add('sobre procedimentos odontológico no dia '+ FormatDateTime('DD/MM/YYYY', FieldByName('DATA').AsDateTime));
          mmoDescricao.Lines.Add('Às ' + FieldByName('HORAINI').AsString + ' até às ' + FieldByName('HORAFIM').AsString);
      ...
      Else
        Begin
          ...
          mmoDescricaoSemCab.Lines.Add('sobre procedimentos odontológico no dia '+ FormatDateTime('DD/MM/YYYY', FieldByName('DATA').AsDateTime));
          mmoDescricaoSemCab.Lines.Add('Às ' + FieldByName('HORAINI').AsString + ' até às ' + FieldByName('HORAFIM').AsString);
