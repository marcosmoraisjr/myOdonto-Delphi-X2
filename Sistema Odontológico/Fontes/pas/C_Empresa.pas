...
begin
  ...
  Begin
    Application.MessageBox('O campo "Nome" é obrigatório o preenchimento !',
  ...
  Begin
    Application.MessageBox
      ('O campo "Razão Social" é obrigatório o preenchimento !', 'Erro!!!',
      mb_ok + MB_ICONERROR);
    EdtRazao.SetFocus;
    Exit;
  End;
  ...
  Begin
    Application.MessageBox('O campo "Cidade" é obrigatório o preenchimento !',
      'Erro!!!', mb_ok + MB_ICONERROR);
  ...
  Begin
    Application.MessageBox('O campo "Endereço" é obrigatório o preenchimento !',
      'Erro!!!', mb_ok + MB_ICONERROR);
  ...
  Begin
    Application.MessageBox('O campo "Número" é obrigatório o preenchimento !',
      'Erro!!!', mb_ok + MB_ICONERROR);
    EdtNumero.SetFocus;
    Exit;
  End;
  ...
  Begin
    Application.MessageBox('O campo "Bairro" é obrigatório o preenchimento !',
      'Erro!!!', mb_ok + MB_ICONERROR);
    EdtBairro.SetFocus;
    Exit;
  End;
  ...
  if EdtCep.Text = '  .   -   ' then
  Begin
    Application.MessageBox('O campo "CEP" é obrigatório o preenchimento !',
      'Erro!!!', mb_ok + MB_ICONERROR);
    EdtCep.SetFocus;
    Exit;
  End;
