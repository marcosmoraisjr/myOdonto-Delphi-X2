...
begin
  ...
  Begin
    application.MessageBox
      ('É obrigatório informar um Dentista Responsável pelo plano de tratamento!',
  ...
  Begin
    application.MessageBox
      ('É obrigatório informar a data de incio do plano de tratamento!',
      'Erro!!!', mb_ok + MB_ICONERROR);
  ...
  Begin
    application.MessageBox
      ('É obrigatório informar a previsão de término do plano de tratamento!',
      'Erro!!!', mb_ok + MB_ICONERROR);
  ...
  Begin
    ...
    Append;
    FieldByName('ID_PACIENTE').AsInteger := iIDPaciente;
    FieldByName('DESCRICAO').AsString := 'Novo Plano de Tratamento de: '+ EdtDtInicio.Text+ ' até: ' +EdtPrevisaoFim.Text;
