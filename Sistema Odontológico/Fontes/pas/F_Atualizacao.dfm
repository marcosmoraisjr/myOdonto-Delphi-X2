inherited frmAtualizacao: TfrmAtualizacao
  ClientHeight = 293
  ClientWidth = 690
  OnCreate = FormCreate
  ExplicitWidth = 696
  ...
  object Barra: TcxProgressBar [4]
    ...
    Properties.Text = 'Atualizando...'
    TabOrder = 2
    Width = 690
  end
  object mmoLog: TMemo [5]
    Left = 0
    Top = 206
    Width = 690
    Height = 63
  ...
  object ODSImagens: TADOConnection
    KeepConnection = False
    LoginPrompt = False
    Left = 112
    Top = 136
  end
  object ODSWord: TADOConnection
    KeepConnection = False
    LoginPrompt = False
    Left = 184
    Top = 136
  end
  object ODSUpdate: TADOConnection
    KeepConnection = False
    LoginPrompt = False
    Left = 252
    Top = 136
