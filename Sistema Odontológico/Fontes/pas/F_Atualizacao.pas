...
begin
  ...
  Begin
    ...
    AtualizaDBO('ALTER TABLE CHEQUESRECEBIDO ADD NOMEREP VARCHAR(200), TELREP VARCHAR(100)');
    ...
    AtualizaDBO('ALTER TABLE CFGGERAL ADD VALIDACPF BIT');
    AtualizaDBO('ALTER TABLE PACIENTE ADD NOMERESPONSAVEL VARCHAR(100), CPFRESPONSAVEL VARCHAR(50), RGRESPONSAVEL VARCHAR(50)');
    iBanco := iBanco +1;
  End;

  if iBanco = 21 then
  Begin
     AtualizaDBO('ALTER TABLE PACIENTE ADD MAOCLUSAOCLASSE INT, MAOCLUSAOMORDIDA INT, MAOCLUSAOEXTRACAO INT');
  End;
