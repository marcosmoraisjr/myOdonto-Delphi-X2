inherited frmParcelamentoContaReceber: TfrmParcelamentoContaReceber
  ClientHeight = 294
  ClientWidth = 344
  ...
  object qryParcelas: TADOQuery
    ...
    SQL.Strings = (
      ...
      'NEW adDouble Valor')
    Left = 200
    object qryParcelasDataPgto: TDateTimeField
      FieldName = 'DataPgto'
