inherited frmAtestado: TfrmAtestado
  ClientHeight = 356
  ClientWidth = 478
  OnCreate = FormCreate
  ExplicitWidth = 484
  ...
  object GroupBox1: TGroupBox [2]
    ...
    object rgFins: TRadioGroup
      Left = 0
      Top = 81
      Width = 185
      Height = 45
      Caption = 'Fins do Atestado'
      Columns = 2
      ItemIndex = 0
      Items.Strings = (
        'Escolares'
    ...
    object GroupBox3: TGroupBox
      ...
      Width = 284
      Height = 45
      Caption = 'Hor'#225'rio da Consulta'
      TabOrder = 3
      ...
      object EdtHoraInicial: TJvTimeEdit
        Left = 35
        Top = 16
        Width = 93
        Height = 21
