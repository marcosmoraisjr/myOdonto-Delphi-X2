inherited frmAbreCaixa: TfrmAbreCaixa
  ...
  object GroupBox1: TGroupBox [4]
    ...
    object EdtDtaCaixa: TJvDateEdit
      Left = 107
      Top = 44
      Width = 113
      Height = 21
    ...
    object cbSaldoRetirado: TComboBox
      Left = 107
      Top = 73
      Width = 113
      Height = 21
    ...
    object EdtOperador: TJvDBSearchComboBox
      Left = 107
      Top = 15
      Width = 113
      Height = 21
  ...
  object qryOperadores: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT ID_OPERADORES, NOME FROM OPERADORES')
    Left = 176
    Top = 1
    object qryOperadoresID_OPERADORES: TAutoIncField
