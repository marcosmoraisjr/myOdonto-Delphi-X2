...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista conferência de lançamentos caixa!',
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de  cidades!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de convenios!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para lançar um reforço no caixa!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
  ...
  Begin
    application.MessageBox('Impossível lançar um refoço no caixa geral!',
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para acessar a lista de termos de consentimentos!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
var
  sDelete : String;
begin
  If Application.MessageBox(PChar('Deseja deletar esse lembrete?'), 'Atenção!',
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar o Caixa!', 'Acesso Negado',
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para acessar a lista de paciêntes!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para acessar a lista de fornecedores!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    ...
    Begin
      application.MessageBox
        ('Você deve cadastrar um consultório antes de começar utilizar o sistema.',
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para abrir um novo Caixa!', 'Acesso Negado',
      mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de Cheques Recebidos!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista conferência de lançamentos banco!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  If application.MessageBox('Para realizar uma Cópia de Segurança é necessário que o sistema seja finalizado, Deseja Continuar?', 'Atenção!', MB_YESNO + MB_ICONQUESTION + MB_DEFBUTTON2) = IDYES Then
  Begin
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a ficha da agenda!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de documentos personalizados!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de receituário!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para acessar a lista de atestados!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para acessar a lista de contas bancárias!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de Títulos a Receber Convênio!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para efetuar lançamentos no caixa!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de documentos emitidos!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox('Operador não tem permissão para transferir saldos!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para efetuar um saque de valores!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para cadastrar um encaixe!', 'Acesso Negado',
      mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox('Operador não tem permissão para editar um encaixe!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar o relatório do caixa geral!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de Títulos a Pagar!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de Títulos a Receber Particular!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de dentistas!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de operadores!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para visualizar a lista de procedimentos!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        application.MessageBox(PChar(sMsg), 'Atenção',
...
begin
  ...
  Begin
    ...
    Begin
      ...
      DataDemo := now + 30; // adiciona 30 dias de demontração
      ...
      application.MessageBox('Obrigado por instalar o Sistema Odontosis,' + #13
        + #10 + 'você tem 15 dias para avaliação', 'Obrigado!!!',
  ...
  Begin
    ...
    begin
      ...
      //   If RenovaOnlineMensalidade(iConexao, sCodCliente) then Exit;
        ...
        application.MessageBox(PChar('Data de Avaliação Expirou.' + #13 + #10 +
          'Entre em contato com a Odontosis.' + #13 + #10 +
          'Pelo site: www.odontosis.com.br' + #13 + #10 + 'ou pelo Fone: ' +
          sFone), 'Atenção!', mb_ok + MB_ICONWARNING);
      ...
      Begin
        application.MessageBox(PChar('Esta é uma versão de demonstração.' + #13
          + #10 + 'Estaremos à disposição para quaisquer esclarecimentos e dúvidas.'
          + #13 + #10 + 'Pelo site: www.odontosis.com.br' + #13 + #10 +
          'ou pelo Fone: ' + sFone), 'Atenção!', mb_ok + MB_ICONWARNING);
      End;
      ...
      Begin
        ...
        iRes := application.MessageBox
          (PChar('Restam ' + IntToStr(iDias) + ' dia(s) de execução do Sistema '
          + #10 + #13 + 'Deseja contatar a Odontosis (Fone: ' + sFone + ')' +
          #13 + #10 +
          'neste momento para renovar o periodo de uso do sistema?'), 'Atenção',
      ...
      Begin
        If RenovaOnlineMensalidade(iConexao, sCodCliente) then Exit;
        iRes := application.MessageBox
          (PChar('Este é o ultimo dia de execução do Sistema' + #10 + #13 +
