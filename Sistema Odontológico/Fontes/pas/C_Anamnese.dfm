inherited frmCadastroAnamnese: TfrmCadastroAnamnese
  ClientHeight = 369
  ClientWidth = 467
  OnCreate = FormCreate
  ExplicitWidth = 473
  ...
  object qryPerguntas: TADOQuery
    ...
    SQL.Strings = (
      'SHAPE APPEND'
      'NEW adInteger IDAnamnese,'
      'NEW adInteger IDPergunta,'
    ...
    object qryPerguntasIDAnamnese: TIntegerField
      FieldName = 'IDAnamnese'
    end
    object qryPerguntasIDPergunta: TIntegerField
      FieldName = 'IDPergunta'
    end
  end
