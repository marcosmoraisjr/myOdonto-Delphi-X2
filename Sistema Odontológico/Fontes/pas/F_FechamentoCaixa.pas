      ...
      Begin
        ...
        Begin
          application.MessageBox
            ('Operador não tem permissão para fechar o Caixa!',
        ...
        Begin
          application.MessageBox
            ('Fechamento do caixa definitivo somente é permitido no Caixa Geral!',
            'Atenção!', mb_ok + MB_ICONWARNING);
          Exit;
        End;

        If application.MessageBox
          (PChar('Ao fechar definitivamente o caixa não haverá possibilidade da realização de lançamentos. Deseja Continuar?'),
          'Atenção', MB_YESNO OR MB_DEFBUTTON2 OR MB_ICONEXCLAMATION)
          = IDYES Then
        Begin
          FechaCaixa;
        End
...
begin
  ...
  Begin
    ...
    Append;
    FieldByName('DESCRICAO').AsString := 'Cheque à Vista';
    ...
    Append;
    FieldByName('DESCRICAO').AsString := 'Cheque à Prazo';
  ...
  Begin
    ...
    Begin
      ...
      Begin
        iTipo := 1;
      End
      Else if qryValoresDescricao.AsString = 'Cheque à Vista' then
      Begin
        iTipo := 2;
      End
      Else if qryValoresDescricao.AsString = 'Cheque à Prazo' then
      Begin
        iTipo := 3;
      End
      Else
...
begin
  ...
  Begin
    ...
    case rgTipo.ItemIndex of
      0:
        Begin
          relPrevia.ReportTitle := 'PRÉVIA DO CAIXA';
        End;
      1:
        Begin
    ...
    Begin
      ...
      Begin
        ...
        lblCaixaCab.Caption := 'Caixa: ' + FieldByName('DTACAIXA').AsString +
          ' - ' + FieldByName('NUMERO').AsString + ' - Responsável: ' +
      ...
      Append;
      FieldByName('FORMAPAGAMENTO').AsString := 'Cheque à Vista';
      ...
      Begin
        ...
        While not qryValores.Eof do
        Begin
          if qryValoresDescricao.AsString = 'Cheque à Vista' then
          Begin
            rInformado := qryValoresValor.AsFloat;
            rDiferenca := rInformado - qryValoresValorCaixa.AsFloat;
          End;
      ...
      Append;
      FieldByName('FORMAPAGAMENTO').AsString := 'Cheque à Prazo';
      ...
      Begin
        ...
        While not qryValores.Eof do
        Begin
          if qryValoresDescricao.AsString = 'Cheque à Prazo' then
          Begin
            rInformado := qryValoresValor.AsFloat;
            rDiferenca := rInformado - qryValoresValorCaixa.AsFloat;
          End;
