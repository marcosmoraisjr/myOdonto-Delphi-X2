inherited frmLAnmenese: TfrmLAnmenese
  ClientHeight = 495
  ClientWidth = 773
  OnCreate = FormCreate
  ExplicitTop = -104
  ...
  object btnSelecionar: TcxButton [3]
    Left = 0
    Top = 426
    Width = 120
    Height = 46
  ...
  object qryPesquisa: TADOQuery
    ...
    Left = 267
    Top = 65528
    object qryPesquisaID_ANAMNESE: TAutoIncField
      FieldName = 'ID_ANAMNESE'
      ReadOnly = True
    end
  ...
  object qryPerguntas: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM PERGUNTASANAMNESE')
    Left = 443
    Top = 96
    object qryPerguntasID_PERGUNTASANAMNESE: TAutoIncField
      FieldName = 'ID_PERGUNTASANAMNESE'
      ReadOnly = True
    end
    object qryPerguntasID_ANAMNESE: TIntegerField
      FieldName = 'ID_ANAMNESE'
    end
