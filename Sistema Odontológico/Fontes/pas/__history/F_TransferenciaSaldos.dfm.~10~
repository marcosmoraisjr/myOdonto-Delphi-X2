inherited frmTransferenciaSaldos: TfrmTransferenciaSaldos
  ClientHeight = 167
  ClientWidth = 548
  OnCreate = FormCreate
  ExplicitWidth = 554
  ...
  object GroupBox1: TGroupBox [4]
    ...
    object cmbContaOrigem: TComboBox
      Left = 96
      Top = 8
      Width = 153
      Height = 21
      ...
      TabOrder = 0
      OnClick = cmbContaOrigemClick
    end
    object cmbContaDestino: TComboBox
      Left = 362
      Top = 8
      Width = 153
      Height = 21
    ...
    object EdtValorSaldo: TcxCurrencyEdit
      Left = 96
      Top = 35
