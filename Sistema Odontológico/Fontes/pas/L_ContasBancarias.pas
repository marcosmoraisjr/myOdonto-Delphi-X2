...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para cadastrar uma conta bancária!',
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para editar uma conta bancária!',
      'Acesso Negado', mb_ok + MB_ICONWARNING);
    Exit;
  End;
...
begin
  inherited;
    ...
    if ACol = 4 then
      Begin
        GroupBox1.Caption := 'Número da Conta';
    ...
    if ACol = 5 then
      Begin
        GroupBox1.Caption := 'Número da Agência';
