...
uses
  ...
  JvDBSearchEdit, Vcl.PlatformDefaultStyleActnCtrls, Vcl.ActnPopup,
  Menus, cxButtons;
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para cadastrar um dentista!',
...
begin
  ...
  Begin
    application.MessageBox
      ('Operador não tem permissão para editar um dentista!', 'Acesso Negado',
      mb_ok + MB_ICONWARNING);
    Exit;
  End;

  sIDAux := qryPadrao.FieldByName('ID_MEDICO').AsString;
  ...
  qryPadrao.Close;
  qryPadrao.Open;
  qryPadrao.Locate('ID_MEDICO', sIDAux, []);
end;
  ...
  case ACol of
    ...
    5:
      Begin
        ...
        GroupBox1.Caption := 'Número do CRO';
