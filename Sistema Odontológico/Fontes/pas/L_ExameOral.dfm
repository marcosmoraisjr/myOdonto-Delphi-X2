inherited frmCadastroExameOral: TfrmCadastroExameOral
  ClientHeight = 496
  ClientWidth = 898
  ExplicitWidth = 904
  ExplicitHeight = 520
  PixelsPerInch = 96
  TextHeight = 13
  object btnAdicionar: TSpeedButton [0]
    Left = 124
    Top = 431
    Width = 135
    Height = 41
  ...
  object btnSelecionar: TSpeedButton [1]
    Left = 0
    Top = 431
    Width = 130
    Height = 41
  ...
  object btnFechar: TSpeedButton [3]
    Left = 503
    Top = 431
    Width = 145
    Height = 41
  ...
  object qryPesquisa: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM EXAMEORAL')
    Left = 275
    Top = 128
    object qryPesquisaID_EXAMEORAL: TAutoIncField
      FieldName = 'ID_EXAMEORAL'
      ReadOnly = True
    end
  ...
  object qryPerguntas: TADOQuery
    Active = True
    Connection = DM.Conexao
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM PERGUNTASEXAMEORAL')
    Left = 443
    Top = 96
    object qryPerguntasID_PERGUNTASEXAMEORAL: TAutoIncField
      FieldName = 'ID_PERGUNTASEXAMEORAL'
      ReadOnly = True
    end
    object qryPerguntasID_EXAMEORAL: TIntegerField
      FieldName = 'ID_EXAMEORAL'
    end
    object qryPerguntasPERGUNTA: TStringField
      FieldName = 'PERGUNTA'
      Size = 60
    end
    object qryPerguntasOBRIGATORIO: TBooleanField
      FieldName = 'OBRIGATORIO'
    end
  end
  object Perguntas: TDataSource
