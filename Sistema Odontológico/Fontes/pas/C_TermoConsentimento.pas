...
begin
  ...
  if (gbResponsavel.Visible) then
    Begin
       If (EdtNomeResponsavel.Text = '') then
        Begin
          application.MessageBox('O Campo "Nome do Responsável" é obrigatório o preenchimento!','Erro!!!',mb_ok+MB_ICONERROR);
          Exit;
        End;

       If (EdtRG.Text = '') then
        Begin
          application.MessageBox('O Campo "RG do Responsável" é obrigatório o preenchimento!','Erro!!!',mb_ok+MB_ICONERROR);
          Exit;
        End;
    End;
  ...
  if EdtCodM.Text = '' then
    Begin
       application.MessageBox('O Campo "Dentista" é obrigatório o preenchimento!','Erro!!!',mb_ok+MB_ICONERROR);
       Exit;
    End;
